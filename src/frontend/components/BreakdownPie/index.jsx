...
import { CATEGORIES } from '../../../backend/data/constants';
...
function BreakdownPie({ byCategory, reducedMotion = false }) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label={`Donut chart showing carbon footprint by category: ${ariaDescription}`}
    >
