...
import { DEMO_MONTHLY_DATA, DEFAULT_DASHBOARD_BREAKDOWN } from '../../../backend/data/constants';
import { useReducedMotion } from '../../../backend/hooks';
...
/**
 * @component Dashboard
 * @description Main view summarizing user's carbon footprint, progress, and actionable insights.
 *
 * @param {Object} props
 * @param {number} props.annualKg - Estimated total annual carbon footprint
 * @param {Array} props.log - List of logged activities
 * @param {Object} props.breakdown - CO2 breakdown by category
 * @param {string[]} props.completedTips - Array of completed tip IDs
 * @param {string[]} props.joinedChallenges - Array of joined challenge IDs
 *
